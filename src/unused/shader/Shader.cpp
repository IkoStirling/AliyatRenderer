...
void Shader::setUniform2f(const std::string& type_name, glm::vec2 value)
{
	GLint location = glGetUniformLocation(shaderProgram, type_name.c_str());
...
void Shader::setUniform3f(const std::string& type_name, float value1, float value2, float value3)
{
	GLint location = glGetUniformLocation(shaderProgram, type_name.c_str());
...
void Shader::setUniform3f(const std::string& type_name, glm::vec3 value)
{
	GLint location = glGetUniformLocation(shaderProgram, type_name.c_str());
