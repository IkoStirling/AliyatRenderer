...
namespace ayt::engine::render
{
    ...
    private:
        ...
        struct BatchKey
        {
            ...
            Material::Type materialType;  // 材质类型
    ...
    public:
        ...
        void drawArrow2D(const math::Transform& transform,
        ...
        void drawRect2D(const math::Transform& transform,
            const math::Vector2& size,
            uint32_t materialID,
            bool wireframe = false,
            Space space = Space::World);    //实例化渲染

        void drawCircle2D(const math::Transform& transform,
            float radius,
            uint32_t materialID,
            int segments = 32,
            bool wireframe = false,
        ...
        //void drawCapsule2D(const math::Vector2& base, const math::Vector2& tip, float radius, const math::Vector4& color);

        // 3D基础图形


        void drawBox3D(const math::Transform& transform,
            const math::Vector3& half_extents,
            uint32_t materialID,
            bool wireframe = true,
            Space space = Space::World);

        void drawMesh(const math::Transform& transform,
            const Mesh& mesh,
            bool wireframe,
            Space space);

        //void drawSphere3D(const math::Transform& transform,
        //    float radius, const math::Vector4& color,
        //    int segments = 16);

        //// 复合图形
        //void drawCapsule3D(const math::Transform& transform,
        //    float radius,
        //    float half_height,
        //    const math::Vector4& color,
        //    int segments = 8);

        //void drawCylinder3D(const math::Transform& transform,
        //    float radius,
        //    float halfHeight,
        //    const math::Vector4& color,
        //    int segments = 12);

        //void drawMesh3D(const math::Transform& transform,
        //    const std::vector<math::Vector3>& vertices,
        //    const std::vector<uint32_t>& indices,
        //    const math::Vector4& color,
        //    bool wireframe = false);

        //void drawArrow3D(const math::Vector3& from, const math::Vector3& to, float headSize, const math::Vector4& color);

        // 辅助标记
        //void drawCross2D(const math::Vector2& position, float size, const math::Vector4& color);
        //void drawCross3D(const math::Vector3& position, float size, const math::Vector4& color);
        //void drawGrid2D(const math::Vector2& center, int divisions, float spacing, const math::Vector4& color);
        //void drawGrid3D(const math::Vector3& center, int divisions, float spacing, const math::Vector3& axisColor);

        // 射线检测可视化
        //void drawRay2D(const math::Vector2& origin, const math::Vector2& direction, float length, const math::Vector4& color);
        //void drawRay3D(const math::Vector3& origin, const math::Vector3& direction, float length, const math::Vector4& color);
    ...
    private:
        void switchBatchDraw(Space space,
            ...
            bool useInstanced,
            Material::Type m_type = Material::Type::None,
        ...
        struct TransparentMeshInstance {
            math::Transform transform;  // 网格的世界变换
            Mesh mesh;           // 网格数据
