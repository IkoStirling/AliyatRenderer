...
namespace ayt::engine::render
{
    ...
    void SkyboxRenderer::render(const RenderContext& context)
    {
        ...
        math::Matrix4 view = math::Matrix4(math::Matrix3(camera->getViewMatrix())); // 移除平移部分
        ...
        math::Matrix4 inverseView = glm::inverse(view);
    ...
    void SkyboxRenderer::_loadSkyboxRendererConfigINI()
    {
        ...
        _vertexPath = _config.get<std::string>("shader path.skybox_vertex",
            Path::Engine::getPresetShaderPath() + std::string("SkyboxRenderer/skybox.vert"));
