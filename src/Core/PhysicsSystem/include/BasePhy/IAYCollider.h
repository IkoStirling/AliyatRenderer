...
namespace ayt::engine::physics
{
    ...
    public:
        ...
        virtual void setOffset(const math::Vector2& offset) { _offset = offset; }
        virtual math::Vector2 getOffset() const { return _offset; }
        virtual void setRotation(const math::Vector3& rotation) { _rotation = rotation; }
    ...
    protected:
        ...
        math::Vector3 _rotation = { 0.0f, 0.0f, 0.0f };
